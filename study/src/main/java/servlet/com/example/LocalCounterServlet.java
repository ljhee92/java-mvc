...
public class LocalCounterServlet extends HttpServlet {
    ...
    public void init(final ServletConfig config) throws ServletException {
        super.init(config);
        getServletContext().log("init() 호출, thread: " + Thread.currentThread().getName());
    }
    ...
    protected void service(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
        getServletContext().log("service() 호출, thread: " + Thread.currentThread().getName());
    ...
    @Override
    public void destroy() {
        getServletContext().log("destroy() 호출, thread: " + Thread.currentThread().getName());
    }
}
